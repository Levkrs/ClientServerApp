...
from common.vars import DEF_PORT, DEF_IP, EXIT, ACTION, TIME, ACCOUNT_NAME, MESSAGE, SENDER, DESTINATION, MESSAGE_TEXT, \
    PRESENCE, USER, ERROR, RESPONCE, DEF_IP_ADDRES_FOR_CLIENT, GET_CONTACT, ADD_CONTACT, DEL_CONTACT, USER_ID_TO_CONTACT, \
    CUSTOM_RESPONCE, MSG_RESP, DATA
import argparse
import select
import time
import threading
...
class ClientSenderClass(threading.Thread, metaclass=ClientMaker):
